<?php
/*
Plugin Name: Gravity Forms Add Subtotal Merge Tag
Plugin URI: http://gravitywiz.com/subtotal-merge-tag-for-calculations/
Description: Adds a {subtotal} merge tag which calculates the subtotal of the form. This merge tag can only be used within the "Formula" setting of Calculation-enabled fields (i.e. Number, Calculated Product).
Version: 1.0
Author: David Smith
