...
class Coauthors_Extend {
	...
	public function __construct() {
		...
		$this->plugin_name = 'co-authors-extend';
		$this->version = '0.0.1';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-co-authors-extend-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-co-authors-extend-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-co-authors-extend-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-co-authors-extend-public.php';

		$this->loader = new Coauthors_Extend_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Coauthors_Extend_i18n();
