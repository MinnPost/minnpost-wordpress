...
/**
 * Delete appnexus-acm-provider-admin.css and appnexus-acm-provider-admin.min.css before we minify and optimize
 */
gulp.task( 'clean:styles', () =>
	del( [ 'assets/css/appnexus-acm-provider-admin.css', 'assets/css/appnexus-acm-provider-admin.min.css' ] )
);
...
gulp.task( 'postcss', [ 'clean:styles' ], () =>
	gulp.src( 'assets/sass/*.scss', paths.css )
		...
		// Create appnexus-acm-provider-admin.css.
		.pipe( gulp.dest( 'assets/css/' ) )
		.pipe( browserSync.stream() )
);

/**
 * Minify and optimize appnexus-acm-provider-admin.css.
 *
 * https://www.npmjs.com/package/gulp-cssnano
 */
gulp.task( 'cssnano', [ 'postcss' ], () =>
	gulp.src( 'assets/css/appnexus-acm-provider-admin.css' )
		.pipe( plumber( {'errorHandler': handleErrors} ) )
		.pipe( cssnano( {
			'safe': true // Use safe optimizations.
		} ) )
		.pipe( rename( 'appnexus-acm-provider-admin.min.css' ) )
		.pipe( gulp.dest( 'assets/css' ) )
		.pipe( browserSync.stream() )
);
...
gulp.task( 'concat', () =>
	gulp.src( paths.concat_scripts )
		...
		.pipe( concat( 'appnexus-acm-provider-admin.js' ) )

		// Append the sourcemap to appnexus-acm-provider-admin.js.
		.pipe( sourcemaps.write() )

		// Save appnexus-acm-provider-admin.js
 ...
 */
gulp.task( 'clean:pot', () =>
	del( [ 'languages/appnexus-acm-provider.pot' ] )
);
...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( sort() )
		.pipe( wpPot( {
			'domain': 'appnexus-acm-provider',
			'package': 'appnexus-acm-provider',
		} ) )
		.pipe( gulp.dest( 'languages/appnexus-acm-provider.pot' ) )
);
