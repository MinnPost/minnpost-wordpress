...
if (
	...
	class Tribe__Extension__Speaker_Linked_Post_Type extends Tribe__Extension {
		...
		/**
		 * Output the events associated with one of our posts.
		 *
		 * @see tribe_organizer_upcoming_events()
		 *
		 * @return string
		 */
		public function get_events( $post_id = false ) {
			...
			if ( $post_id ) {
				...
				$events = apply_filters( 'tribe_ext_' . self::POST_TYPE_KEY . '_get_events', $events, $args );
				return $events;
			}
		}
